...
function Login_Choice() {
  return (
    ...
    <div className='h-screen w-full flex'>
        {/* Left Side */}
        <div className='h-screen w-1/2 bg-red-600 flex flex-col justify-center items-center'>
            <h1 className='text-7xl font-bold text-white mb-10'>Are You Buyer ?</h1>
            <div className='flex'>
        ...
        {/* Right Side */}
        <div className='h-screen w-1/2 bg-white flex flex-col justify-center items-center'>
        <h1 className='text-7xl font-bold text-red-600 mb-10'>Are You Seller ?</h1>
            <div className='flex'>
