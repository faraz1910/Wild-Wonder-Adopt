...
const AboutUsPage = () => {
  ...
  <div className="ReviewContent w-[1414px] h-[408px] left-[13px] top-[913px] absolute">
    ...
    <div className="Review1 w-[265px] h-16 left-[88px] top-[140px] absolute text-center text-black text-4xl font-normal font-['Yrsa']">Review 1</div>
    <div className="Review2 w-[265px] h-16 left-[575px] top-[140px] absolute text-center text-black text-4xl font-normal font-['Yrsa']">Review 2</div>
    <div className="Review3 w-[265px] h-16 left-[1061px] top-[140px] absolute text-center text-black text-4xl font-normal font-['Yrsa']">Review 3</div>
  </div>
  <div className="ContactContent w-[1414px] h-[394px] left-[13px] top-[1474px] absolute">
    ...
    <div className="LoremIpsumDolorSitAmetConsecteturAdipiscingElitSedEuDuiHendreritEfficiturNequeInTempusElit w-[1058px] h-[127px] left-[178px] top-[134px] absolute text-center text-black text-2xl font-light font-['Merriweather']">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eu dui hendrerit, efficitur neque in, tempus elit</div>
  </div>
  <div className="AboutUsContent w-[1072px] h-[267px] left-[184px] top-[367px] absolute">
    <img className="Exclusive1 w-[183px] h-[173.02px] left-[447px] top-0 absolute" src="https://via.placeholder.com/183x173" />
    <img className="Salad11 w-[183px] h-[162px] left-[25px] top-0 absolute" src="https://via.placeholder.com/183x162" />
    ...
    <img className="RepairingService1 w-[183px] h-[162px] left-[869px] top-0 absolute" src="https://via.placeholder.com/183x162" />
